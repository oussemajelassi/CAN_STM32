...
void vCAN_FilterInit ( void )
{
	...
	CAN_IncomingDataFILTER.FilterID1 	= CAN_MessageID << 5 ;
	CAN_IncomingDataFILTER.FilterID2 	= CAN_MessageID << 5 ;
	CAN_IncomingDataFILTER.FilterIndex 	= 0 ;
...
void vCAN_TX_HeaderInit ( void )
{
	...
	CAN_SentDataHEADER.FDFormat = FDCAN_FD_CAN ;
